...
export const checkZoneBreaches = async (req, res) => {
  try {
    ...
    logger.error('Check zone breaches error:', error);
    res.status(500).json({ status: 'error', message: 'Internal Server Error' });
  }
};
...
export const sendTeamAnnouncement = async (req, res) => {
  ...
  try {
    ...
    logger.error('Send team announcement error:', error);
    res.status(500).json({ status: 'error', message: 'Internal Server Error' });
  }
};
...
export const getMyTeamMembers = async (req, res) => {
  try {
    ...
    logger.error('Get my team members error:', error);
    res.status(500).json({ status: 'error', message: 'Internal Server Error' });
  }
};
...
export const getTeamsByProject = async (req, res) => {
  ...
  try {
    ...
    logger.error('Get teams by project error:', error);
    res.status(500).json({ status: 'error', message: 'Internal Server Error' });
  }
};

export const manageTeamSession = async (req, res) => {
  ...
  try {
    ...
    if (action === 'start') {
      ...
      return res.status(400).json({ status: 'error', message: 'Invalid action. Use start, end, or status' });
    }
  } catch (error) {
    logger.error('Team session error:', error);
    res.status(500).json({ status: 'error', message: 'Internal Server Error' });
  }
};
